...
# ~/.pimon/signing/releases/<version>/checksums.txt.sig. The checksums.txt is
...
SIGNING_DIR="${PIMON_SIGNING_DIR:-$HOME/.pimon/signing}"
SECRET_KEY="${PIMON_SIGNING_KEY:-$SIGNING_DIR/secret.pem}"
...
Environment:
  PIMON_SIGNING_DIR   Override the signing directory (default: ~/.pimon/signing)
  PIMON_SIGNING_KEY   Override the secret key path
EOF
}
